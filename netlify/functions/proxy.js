exports.handler = async function(event) {
  ...
  try {
    ...
    const accionesConBodyGrande = ["guardar_archivo_job", "leer_archivo_job", "limpiar_archivo_job", "crear_lote"];
    ...
    try {
      ...
      // En vez de ocultar el problema, devolvemos un fragmento del texto
      // real que contestó Apps Script (HTML de error, redirect, etc.)
      // para poder diagnosticar qué está pasando.
      return {
        statusCode: 500,
        headers,
        body: JSON.stringify({
          ...
          respuestaCruda: text.substring(0, 1500)
        })
      };
    }
