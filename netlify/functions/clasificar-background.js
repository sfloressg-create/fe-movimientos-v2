...
async function guardarEnAppsScript(appsScriptUrl, jobId, resultado) {
  try {
    ...
    // Si esto falla no hay mucho qué hacer — el polling del navegador eventualmente
    // hará timeout y la usuaria podrá reintentar.
  }
}
...
exports.handler = async function (event) {
  ...
  try {
    ...
    if (!appsScriptUrl) return; // sin esto no podemos reportar el resultado a ningún lado
